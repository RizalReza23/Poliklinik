...
<html lang="en">
  ...
  <style>
    ...
    <nav class="navbar fixed-top navbar-expand-lg py-3 navbar-dark" style="background-color:rgb(255, 2, 175);;">
        <div class="container d-flex align-items-center">
            <a class="navbar-brand" href="berandaDokter.php">Poliklinik Penting Sehat</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                ?>
                    <ul class="navbar-nav d-flex align-items-lg-center ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="berandaDokter.php?page=profildokter">Profil</a>
                        </li>
                    </ul>
    ...
    if (isset($_GET['page'])) {
        ...
        echo "<br><h2>Selamat Datang di Poliklinik Penting Sehat";
